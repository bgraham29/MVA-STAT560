...
# ------------------------------------------------------------------------------
# Description:  MVAdecofood computes a spectral decomposition of the French 
#               food data  and gives a representation of food expenditures and
#               family types in two dimensions.
# ------------------------------------------------------------------------------
# Usage:        -
# ------------------------------------------------------------------------------
# Inputs:       None      
...
#               representation of food expenditures and family types in two 
#               dimensions.
# ------------------------------------------------------------------------------
# Example:      -
# ------------------------------------------------------------------------------
# Author:       Zografia Anastasiadou 20110509
# ------------------------------------------------------------------------------
# Keywords:     spectral decomposition, standardization, eigenvalues, eigenvectors
# ------------------------------------------------------------------------------
# See also:     
# ------------------------------------------------------------------------------
...
d      = diag(1/sqrt(colSums(a^2)/n))  # different response than 1/sd
				# note division by n instead of n-1 Why?
